...
import com.github.marcoslorcar.clementime.data.importing.repository.FakeScheduleDaoForRepositoryTest
...
class GitHubScheduleApiTest {
    ...
    fun testNormalizeGitHubUrl() {
        val repo = com.github.marcoslorcar.clementime.data.importing.repository.ImportRepository(
