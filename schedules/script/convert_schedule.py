...
# Standard classroom name normalization dictionary
CLASSROOM_NORMALIZATION = {
    "0.02+3-Charles": "0.02+3-Charles",
    "0.04-Hedy": "0.04-Hedy Lamarr",
    "0.04-Hedy Lamar": "0.04-Hedy Lamarr",
    "0.04-Hedy Lamarr": "0.04-Hedy Lamarr",
    "0.05-Eds": "0.05-Edsger W.",
    "0.05-Edsger W.": "0.05-Edsger W.",
    "0.05-Edsger W. Dijkstra": "0.05-Edsger W. Dijkstra",
    "0.07-Claude Sha": "0.07-Claude Shannon",
    "0.07-Claude Shannon": "0.07-Claude Shannon",
    "0.07-Clau": "0.07-Claude Shannon",
    "A1.1-John Von N": "A1.1-John Von N",
    "A1.1-Joh": "A1.1-John Von N",
    "A1.1-John Von Neumann": "A1.1-John Von Neumann",
    "A1.2-Tim": "A1.2-Tim Berner",
    "A1.2-Tim Berner": "A1.2-Tim Berner",
    "A1.2-Tim Berners-Lee": "A1.2-Tim Berners-Lee",
    "A2.1-George Boo": "A2.1-George Boole",
    "A2.1-Geo": "A2.1-George Boole",
    "A2.2-Grace Murr": "A2.2-Grace Murray",
    "A2.2-Gra": "A2.2-Grace Murray",
    "Alan Turing": "Alan Turing",
    "LD1-Igna": "LD1-Ignacio",
    "LD1-Ignacio Cir": "LD1-Ignacio",
    "LD1-Ignacio Cirac": "LD1-Ignacio Cirac",
    "LD2-Den": "LD2-Dennis Ritchie",
    "LD2-Dennis Ritc": "LD2-Dennis Ritchie",
    "LD2-Dennis Ritchie": "LD2-Dennis Ritchie",
    "LD3-Bill": "LD3-Bill",
    "LD3-Bill Gates": "LD3-Bill Gates",
    "LD4-John": "LD4-John Carmack",
    "LD4-John Carmac": "LD4-John Carmack",
    "LD4-Joh": "LD4-John Carmack"
}
...
class ScheduleParser:
        ...
        for line in table_lines[header_idx + 1:]:
            ...
            for col_idx in range(1, len(cols)):
                ...
                if not parsed_entries and prev_row_entries.get((col_idx, day)):
                    ...
                    classroom = None
                    for key, norm_room in CLASSROOM_NORMALIZATION.items():
                        if key in cell_text:
                            classroom = norm_room
                            break
    ...
    def _parse_cell_entries(self, cell_text: str) -> List[Dict[str, Any]]:
        ...
        if "PruebasProgreso" in cell_text or "Pruebas de" in cell_text:
            ...
            room = "0.02+3-Charles" if m else "0.02+3-Charles"
            entries.append({
...
def main():
    ...
    if (args.strict or args.non_interactive) and (mapper.missing_matters or mapper.missing_professors):
